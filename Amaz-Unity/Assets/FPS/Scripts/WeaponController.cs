...
public class WeaponController : MonoBehaviour
{
    ...
    void Awake()
    {
        m_hitMarker = GameObject.Find("HitMarker/Image").GetComponent<Image>();
    ...
    void CheckHitEnemy()
    {
        if (EnemyController.enemyReceivedDamageFatal.Item1)
        {
            m_hitMarker.color = EnemyController.enemyReceivedDamageFatal.Item2 ? Color.red : Color.white;
            Invoke("DisableHitMarker", 0.2f);
            EnemyController.enemyReceivedDamageFatal = (false, false);
        }
    }
