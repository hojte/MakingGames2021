...
public class InGameMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lookSensitivitySlider.value = PlayerInputHandler.lookSensitivity;
    ...
    {
        PlayerInputHandler.lookSensitivity = newValue;
        PlayerInputHandler.cachedLookSensitivity = newValue;
    }
